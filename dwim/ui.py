...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[dwim.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype dwim.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[dwim.types.CorrectedCommand]
    :rtype: dwim.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('What did you mean?')
        return
