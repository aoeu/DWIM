...
from dwim.exceptions import EmptyCommand
...
class TestCommand(object):
    ...
    def Popen(self, monkeypatch):
        ...
        monkeypatch.setattr('dwim.types.Popen', Popen)
        return Popen

    @pytest.fixture(autouse=True)
    def prepare(self, monkeypatch):
        monkeypatch.setattr('dwim.types.os.environ', {})
        monkeypatch.setattr('dwim.types.Command._wait_output',
